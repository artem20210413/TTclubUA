...
кожен рядок у форматі '@нік: текст' (нік може бути відсутній).
Зроби драйвовий підсумок дня УКРАЇНСЬКОЮ мовою лише про корисне: хто що продає/купує,
домовленості про зустрічі/покатухи, важливі запитання й відповіді, оголошення.
Стиль: {$styleText}.
Правила:
...
- Коротко, до 8 пунктів, кожен — один рядок з емодзі-маркером (🔧, 🏎, ⚡️, 🛠, 💬).
- Якщо корисного немає — відповідай рівно: 'Сьогодні в гаражі тихо, без рухів.'
