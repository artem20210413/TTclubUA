    ...
    <main class="banner">
        <div class="gradient">
            ...
            <div style="display: flex;">
                <div style="display: flex; align-items: flex-start; width: 648px; flex-direction: column; gap: 20px;">
                    <img class="logo" src="{{asset('media/images/logo.webp')}}">
                    <p class="header">Вітаємо! У спільноті фанатів Audi TT</p>
                    <p class="basis">Нас об'єднує стиль, динаміка і любов до легендарної Audi TT. Атмосфера, підтримка,
                        спільні
                        поїздки та
